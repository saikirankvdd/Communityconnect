    ...
    <div className="bg-[#FAF8FF] font-['Plus_Jakarta_Sans',sans-serif] text-[#131B2E] antialiased min-h-screen flex">
      ...
      <aside className="fixed left-0 top-0 h-screen w-72 bg-white z-40 flex flex-col justify-between shadow-[0_1px_8px_rgba(0,0,0,0.04)] select-none border-r border-[#eaedff]">
        <div className="flex flex-col">
          {/* Logo Branding - AUTHENTIC COMMUNITYCONNECT VECTOR LOGO MARK */}
          <div className="h-16 px-5 flex items-center gap-3 bg-white border-b border-[#eaedff]">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-sm tracking-tight leading-tight flex items-center gap-0.5">
                <span className="text-[#006b2c]">Community</span><span className="text-[#0EA5E9]">Connect</span>
              </span>
